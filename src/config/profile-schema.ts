...
export type AgentKind = 'claude' | 'codex' | 'gemini-enterprise';
...
export function normalizeProfileConfig(input: unknown): ProfileConfig {
  ...
  if (raw.agentKind !== 'claude' && raw.agentKind !== 'codex' && raw.agentKind !== 'gemini-enterprise') {
    throw new Error('agentKind must be claude, codex, or gemini-enterprise');
  }
